...
with DAG(
    ...
    schedule=None,
    start_date=pendulum.datetime(2023, 11, 7, tz="UTC"),
    catchup=False,
    tags=["example"],
) as dag:
    ...
    t5 = BashOperator(task_id="remove_file", bash_command="rm -rf /home/harika/airflow/dags/sensor.txt")

    # [START example_file_sensor]
    t6 = FileSensor(task_id="wait_for_file", filepath="/home/harika/airflow/dags/sensor.txt")
    # [END example_file_sensor]

    t7 = BashOperator(
        task_id="create_file_after_3_seconds", bash_command="sleep 3; touch /home/harika/airflow/dags/sensor.txt"
    )
    ...
    t10 = DayOfWeekSensor(
        task_id="week_day_sensor_failing_on_timeout", timeout=3, soft_fail=True, week_day=WeekDay.WEDNESDAY
    )
